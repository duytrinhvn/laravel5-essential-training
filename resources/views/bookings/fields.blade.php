<div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input name="start" type="date" value="{{ $booking->start ?? '' }}" class="form-control" required placeholder="yyyy-mm-dd"/>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            ...
            <input name="is_paid" type="checkbox" class="form-check-input" value="1" {{ isset($booking->is_paid) && $booking->is_paid === true ? 'checked' : '' }}/>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input name="notes" type="text" value="{{ $booking->notes ?? '' }}" class="form-control" placeholder="Notes"/>
